...
public class Server implements ActionListener {
    ...
    Server() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/12.jpeg"));
        ...
        JLabel name = new JLabel("NETHISH");
        ...
        fileButton.setBounds(160, 710, 123, 40);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Server is listening on port 6001...");
            while (true) {
                s = skt.accept();
    ...
    private static void sendFile() {
        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                String message = "File sent: " + selectedFile.getName();
    ...
    private static void receiveFile() {
        try {
            ...
            String message = "File received: " + fileName;
            JPanel panel = formatLabel(message);
